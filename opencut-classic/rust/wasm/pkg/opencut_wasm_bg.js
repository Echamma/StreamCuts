...
export class PreparedColorLut {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreparedColorLut.prototype);
        obj.__wbg_ptr = ptr;
        PreparedColorLutFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedColorLutFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedcolorlut_free(ptr, 0);
    }
    /**
     * @returns {Float32Array}
     */
    get domainMax() {
        const ret = wasm.preparedcolorlut_domainMax(this.__wbg_ptr);
     ...
     */
    get domainMin() {
        const ret = wasm.preparedcolorlut_domainMin(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get identity() {
        const ret = wasm.preparedcolorlut_identity(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    get size() {
        const ret = wasm.preparedcolorlut_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {Float32Array}
     */
    get table() {
        const ret = wasm.preparedcolorlut_table(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
}
if (Symbol.dispose) PreparedColorLut.prototype[Symbol.dispose] = PreparedColorLut.prototype.free;

export class PreparedHslCurves {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreparedHslCurves.prototype);
        obj.__wbg_ptr = ptr;
        PreparedHslCurvesFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedHslCurvesFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedhslcurves_free(ptr, 0);
    }
    /**
     * @returns {boolean}
     */
    get identity() {
        const ret = wasm.preparedhslcurves_identity(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {Float32Array}
     */
    get table() {
        const ret = wasm.preparedhslcurves_table(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
}
if (Symbol.dispose) PreparedHslCurves.prototype[Symbol.dispose] = PreparedHslCurves.prototype.free;

export class PreparedRgbParade {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreparedRgbParade.prototype);
        obj.__wbg_ptr = ptr;
        PreparedRgbParadeFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedRgbParadeFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedrgbparade_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get bins() {
        const ret = wasm.preparedrgbparade_bins(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get columns() {
        const ret = wasm.preparedrgbparade_columns(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {Uint32Array}
     */
    get counts() {
        const ret = wasm.preparedrgbparade_counts(this.__wbg_ptr);
     ...
     */
    get peak() {
        const ret = wasm.preparedrgbparade_peak(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) PreparedRgbParade.prototype[Symbol.dispose] = PreparedRgbParade.prototype.free;
...
export class PreparedToneCurves {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreparedToneCurves.prototype);
        obj.__wbg_ptr = ptr;
        PreparedToneCurvesFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedToneCurvesFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedtonecurves_free(ptr, 0);
    }
    /**
     * @returns {Float32Array}
     */
    get counts() {
        const ret = wasm.preparedtonecurves_counts(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get identity() {
        const ret = wasm.preparedtonecurves_identity(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {Float32Array}
     */
    get nodes() {
        const ret = wasm.preparedtonecurves_nodes(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
}
if (Symbol.dispose) PreparedToneCurves.prototype[Symbol.dispose] = PreparedToneCurves.prototype.free;

export class PreparedVectorscope {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(PreparedVectorscope.prototype);
        obj.__wbg_ptr = ptr;
        PreparedVectorscopeFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        PreparedVectorscopeFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_preparedvectorscope_free(ptr, 0);
    }
    /**
     * @returns {Uint32Array}
     */
    get counts() {
        const ret = wasm.preparedvectorscope_counts(this.__wbg_ptr);
        var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get peak() {
        const ret = wasm.preparedvectorscope_peak(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get size() {
        const ret = wasm.preparedvectorscope_size(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) PreparedVectorscope.prototype[Symbol.dispose] = PreparedVectorscope.prototype.free;

export class SaliencyAnalyzer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SaliencyAnalyzerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_saliencyanalyzer_free(ptr, 0);
    }
    /**
     ...
     */
    analyze(luma) {
        const ret = wasm.saliencyanalyzer_analyze(this.__wbg_ptr, luma);
        if (ret[2]) {
     ...
     */
    lastAnchor() {
        const ret = wasm.saliencyanalyzer_lastAnchor(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    constructor(options) {
        const ret = wasm.saliencyanalyzer_new(options);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        SaliencyAnalyzerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    reset() {
        wasm.saliencyanalyzer_reset(this.__wbg_ptr);
    }
}
if (Symbol.dispose) SaliencyAnalyzer.prototype[Symbol.dispose] = SaliencyAnalyzer.prototype.free;
 ...
 * @param {number} bins
 * @returns {PreparedRgbParade}
 */
export function computeRgbParade(pixels, width, height, columns, bins) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.computeRgbParade(ptr0, len0, width, height, columns, bins);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedRgbParade.__wrap(ret[0]);
}
 ...
 * @param {number} height
 * @param {number} size
 * @returns {PreparedVectorscope}
 */
export function computeVectorscope(pixels, width, height, size) {
    const ptr0 = passArray8ToWasm0(pixels, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.computeVectorscope(ptr0, len0, width, height, size);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedVectorscope.__wrap(ret[0]);
}
...
/**
 * @param {string} text
 * @returns {PreparedColorLut}
 */
export function prepareCubeLut(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.prepareCubeLut(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedColorLut.__wrap(ret[0]);
}

/**
 * @param {any} points
 * @returns {PreparedHslCurves}
 */
export function prepareHslCurves(points) {
    const ret = wasm.prepareHslCurves(points);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedHslCurves.__wrap(ret[0]);
}
 ...
 * @returns {PreparedColorLut}
 */
export function prepareToneCurves(points) {
    const ret = wasm.prepareToneCurves(points);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedColorLut.__wrap(ret[0]);
...
/**
 * @param {any} points
 * @returns {PreparedToneCurves}
 */
export function prepareToneCurvesExact(points) {
    const ret = wasm.prepareToneCurvesExact(points);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return PreparedToneCurves.__wrap(ret[0]);
}
 ...
 * @returns {Float32Array}
 */
export function sampleHslCurve(points, periodic) {
    const ret = wasm.sampleHslCurve(points, periodic);
    if (ret[3]) {
 ...
 * @returns {Float32Array}
 */
export function sampleToneCurve(points) {
    const ret = wasm.sampleToneCurve(points);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
...
export function __wbg_new_typed_5101eada2c6754de(arg0, arg1) {
    try {
        ...
        var cb0 = (arg0, arg1) => {
            ...
            state0.a = 0;
            try {
                return wasm_bindgen__convert__closures_____invoke__h0608ffce712d3686(a, state0.b, arg0, arg1);
            } finally {
                state0.a = a;
            }
        };
...
function wasm_bindgen__convert__closures_____invoke__h2cb231dc5c242a55(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h2cb231dc5c242a55(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h55c376e6c1d698c2(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__h55c376e6c1d698c2(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h0608ffce712d3686(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h0608ffce712d3686(arg0, arg1, arg2, arg3);
}
...
const PreparedColorLutFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_preparedcolorlut_free(ptr >>> 0, 1));
const PreparedHslCurvesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_preparedhslcurves_free(ptr >>> 0, 1));
const PreparedRgbParadeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_preparedrgbparade_free(ptr >>> 0, 1));
const PreparedToneCurvesFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_preparedtonecurves_free(ptr >>> 0, 1));
const PreparedVectorscopeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_preparedvectorscope_free(ptr >>> 0, 1));
const SaliencyAnalyzerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_saliencyanalyzer_free(ptr >>> 0, 1));
