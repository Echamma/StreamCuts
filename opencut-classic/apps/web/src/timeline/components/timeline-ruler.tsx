...
import { useTimeline, useProject } from "@/editor/use-editor";
...
export function TimelineRuler({
	...
	const durationTicks = useTimeline((e) => e.timeline.getTotalDuration());
	...
	const fps =
		useProject((e) => e.project.getActiveOrNull()?.settings.fps) ?? DEFAULT_FPS;
