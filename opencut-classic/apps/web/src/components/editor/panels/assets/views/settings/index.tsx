		...
		>
			{view === "project-info" && (
				<div className="flex flex-col">
					...
					<Section showTopBorder={false}>
						<SectionHeader className="justify-between">
							<SectionTitle className="flex-1">Automatic proxies</SectionTitle>
							<input
								type="checkbox"
								aria-label="Generate proxies automatically"
								checked={activeProject.settings.autoProxies === true}
								onChange={(event) => {
									void editor.project.updateSettings({
										settings: { autoProxies: event.currentTarget.checked },
									});
								}}
							/>
						</SectionHeader>
