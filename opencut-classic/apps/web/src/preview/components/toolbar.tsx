...
import { useEditor, usePlayback, useTimeline, useProject } from "@/editor/use-editor";
...
function TimecodeDisplay() {
	...
	const totalDuration = useTimeline((e) => e.timeline.getTotalDuration());
	const fps = useProject((e) => e.project.getActive().settings.fps);
...
function PlayPauseButton() {
	const isPlaying = usePlayback((e) => e.playback.getIsPlaying());
